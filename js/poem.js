const steps = [
    ...
    { type: "write", text: "Cela fais maintenant 1 mois qu'on est dans un rêve.\n" },
    { type: "write", text: "Et c'est incroyable.\n" },
    { type: "deleteLine" },
    { type: "write", text: "Non MAGIQUE ✨\n" },
    { type: "write", text: "Tu es vraiment quelqu'un d'incroyable.\n" },
    { type: "write", text: "Si j'avais su qu'un jour je rencontrai une personne comme ca\n" },
    { type: "write", text: "Je n'en croirai pas un mot ;).\n" },
    { type: "write", text: "Tu compte beaucoup pour moi\n" },
    { type: "deleteLine" },
    { type: "write", text: "Tu es tout pour moi ❤️\n" },
    { type: "write", text: "Je t'aime plus que tout au monde Mahe ❤️✨\n" },
    { type: "write", text: "Sache qu'en tout cas je serai toujours la pour toi\n" },
    { type: "write", text: "Jamais au grand jamais je te laisserai tomber\n" },
    ...
    { type: "write", text: "Cela fait depuis quelque semaine que je te preparais ça.\n" },
    ...
    { type: "write", text: "Je t'es concoter 3 mini jeux bonne chance mon coeur ❤️" }
];
